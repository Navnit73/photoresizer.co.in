...
export const frPages: SeoPage[] = [
  {
    ...
    metaTitle: 'Redimensionner une photo en ligne gratuitement',
    metaDescription: 'Redimensionnez vos photos en ligne gratuitement. Rapide, sécurisé et sans perte de qualité.',
    h1: 'Redimensionner une photo en ligne',
    subtitle: 'Modifiez rapidement les dimensions de vos images sans perte de qualité.',
    sections: [
      {
        heading: 'Pourquoi utiliser notre outil ?',
        content: 'Il est incroyablement rapide et fonctionne entièrement dans votre navigateur pour une confidentialité maximale.'
      }
    ],
    faq: [
      {
  ...
  {
    slug: 'createur-photo-identite',
      translationKey: 'passport-photo-maker',
    metaTitle: 'Créateur de photo d\'identité | Créer des photos en ligne',
    metaDescription: 'Créez des photos d\'identité conformes en ligne en quelques secondes.',
    h1: 'Créateur de photo d\'identité',
    subtitle: 'Recadrez et formatez facilement vos photos pour les documents officiels.',
    sections: [
      {
        heading: 'Conformité stricte',
        content: 'Nous respectons les exigences numériques strictes de 35x45 mm pour les passeports.'
      }
    ],
    faq: [
      {
        question: 'Quelles sont les dimensions ?',
        answer: 'Les dimensions standard sont de 35x45 mm.'
      }
    ]
  },
  {
    ...
    metaTitle: 'Comment utiliser | photoresizer',
  ...
  <div class="p-6 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
    ...
    <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">1. Télécharger l'image</h3>
    <p class="text-slate-600 dark:text-slate-400">Sélectionnez votre fichier image et faites-le glisser dans la zone de téléchargement.</p>
  </div>
  <div class="p-6 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
    <div class="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center mb-4 text-blue-600 dark:text-blue-400">
    ...
    <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">2. Ajuster les paramètres</h3>
    <p class="text-slate-600 dark:text-slate-400">Utilisez la barre latérale droite pour modifier les dimensions, supprimer l'arrière-plan ou ajuster les couleurs.</p>
  </div>
</div>`
      }
    ]
  },
  {
    ...
    metaTitle: 'Contactez-nous | photoresizer',
