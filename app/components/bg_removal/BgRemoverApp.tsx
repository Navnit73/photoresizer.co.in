...
function BgRemoverLayout() {
  ...
  return (
    <div className="w-full flex flex-col gap-4">
      <div className="w-full flex flex-col bg-white dark:bg-slate-900 rounded-none sm:rounded-2xl overflow-hidden border-0 sm:border border-slate-200 dark:border-slate-800 min-h-[100dvh] sm:min-h-[600px] transition-colors duration-200">
        <div className="flex-shrink-0 z-10 sticky top-0 sm:relative shadow-sm sm:shadow-none">
          <BgRemoverHeader />
        </div>

        <div className="flex-1 flex flex-col lg:flex-row overflow-visible relative z-0">
