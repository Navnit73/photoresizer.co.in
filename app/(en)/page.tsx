        ...
        <section className="mt-16 max-w-5xl mx-auto px-4 md:px-0 space-y-20">
          ...
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
              photoresizer is a zero-installation, zero-upload photo editor that runs entirely inside your browser. Using
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              ...
              social media manager resizing banners for five platforms at once, photoresizer gives you professional-grade
          ...
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-6 leading-relaxed">
              Most free online editors lock key features behind a paywall. photoresizer gives you the full toolkit upfront — no
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-slate-100 dark:bg-slate-800">
                    ...
                    <th className="p-4 font-semibold text-blue-700 dark:text-blue-400">photoresizer</th>
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-emerald-50 dark:from-slate-800/50 dark:to-slate-900/50 rounded-3xl p-8 border border-blue-100 dark:border-slate-700">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
              photoresizer works differently. By running entirely in your browser using WebAssembly, we eliminate that risk
          ...
          <div className="pt-8 border-t border-slate-200 dark:border-slate-800 pb-12">
            <h3 className="text-lg font-bold mb-4 text-slate-800 dark:text-slate-200">Image Resizing &amp; Conversion Tools</h3>
            <div className="flex flex-wrap gap-2">
              {[
